...
from checkmate.evaluators import ThresholdEvaluator
...
class GarakCommands(cmd2.CommandSet):
    ...
    def do_probe(self, args):
        ...
        harness = checkmate.harnesses.probewise.ProbewiseHarness()
...
class GarakTerminal(cmd2.Cmd):
    ...
    def __init__(self):
        ...
        self._load_checkmate()
        self.prompt = "checkmate> "
...
def interactive_mode():
    """
    Launch checkmate in interactive mode. Allows users to explore and use checkmate without CLI flags.
    """
    banner()
