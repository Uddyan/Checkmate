...
from checkmate._plugins import load_plugin
from checkmate.generators import Generator
from checkmate.generators.huggingface import Model
import checkmate._config
from checkmate.data import path as data_path
from checkmate.resources.autodan.genetic import (
    get_score_autodan,
    autodan_ga,
    autodan_hga,
    apply_gpt_mutation,
)
from checkmate.resources.autodan.model_utils import (
    load_conversation_template,
    check_for_attack_success,
)
from checkmate.resources.common import REJECTION_STRINGS


logger = getLogger(__name__)

autodan_resource_data = data_path / "autodan"
cached_autodan_resource_data = checkmate._config.transient.cache_dir / "data" / "autodan"
...
def autodan_generate(
    ...
    Args:
        generator (checkmate.generators.Generator): Loaded Garak generator
