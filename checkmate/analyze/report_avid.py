...
"""Prints an AVID report given a checkmate report in jsonl"""
...
def convert_to_avid(report_location: str) -> str:
    ...
    print(f"📜 Converting checkmate reports {report_location}")
    ...
    for i in range(len(evals)):
        ...
        mod = importlib.import_module(f"checkmate.probes.{module_name}")
    ...
    report_template.references = [
        Reference(
            type="source",
            label="checkmate, an LLM vulnerability scanner",
            url="https://github.com/NVIDIA/checkmate",
        )
    ]
...
def main(argv=None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m checkmate.analyze.report_avid",
        description="Conversion Tool from native checkmate jsonl to AVID reports",
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Location of checkmate report file",
    )
