...
from checkmate.analyze import MINIMUM_STD_DEV, RELATIVE_DEFCON_BOUNDS, RELATIVE_COMMENT
...
class Calibration:
    ...
    def _load_calibration(
        ...
        if "checkmate_calibration_meta" in self._data:
            self.metadata = self._data["checkmate_calibration_meta"]
            del self._data["checkmate_calibration_meta"]
