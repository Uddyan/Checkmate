...
"""
analyze a checkmate report.jsonl log file
...
def main(argv=None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m checkmate.analyze.analyze_log",
        description="Analyze a checkmate JSONL report and emit summary lines",
        epilog="See https://github.com/NVIDIA/checkmate",
        allow_abbrev=False,
    )
    # Support both positional and -r/--report_path for backward compatibility
    parser.add_argument("report_path", nargs="?", help="Path to the checkmate JSONL report")
    parser.add_argument(
        "-r",
        "--report_path",
