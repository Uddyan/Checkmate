...
class OpenAICompatible(Generator):
    ...
    @backoff.on_exception(
        ...
        (
            ...
            checkmate.exception.GarakBackoffTrigger,
        ),
        max_value=70,
    )
    def _call_model(
        ...
        try:
            ...
            logging.exception(e)
            if self.retry_json:
                raise checkmate.exception.GarakBackoffTrigger from e
            else:
                raise e
        ...
        if not hasattr(response, "choices"):
            ...
            if self.retry_json:
                raise checkmate.exception.GarakBackoffTrigger(msg)
            else:
                return [None]
...
class OpenAIGenerator(OpenAICompatible):
    ...
    def _load_client(self):
        ...
        if self.__class__.__name__ == "OpenAIGenerator" and self.name.startswith("o"):
            ...
            logging.error(msg)
            raise checkmate.exception.BadGeneratorException("🛑 " + msg)
