...
When invoking checkmate, specify the path to the generator option file:

.. code-block:: bash

   python -m checkmate --target_type litellm --target_name "phi" --generator_option_file ollama_base.json -p dan
"""
...
from checkmate.exception import BadGeneratorException
