...
from checkmate.buffs.base import Buff
...
class PegasusT5(Buff, HFCompatible):
    ...
    DEFAULT_PARAMS = Buff.DEFAULT_PARAMS | {
        "para_model_name": "checkmate-llm/pegasus_paraphrase",
        "hf_args": {
            "device": "cpu",
    ...
    def transform(
        ...
        for paraphrase in set(paraphrases):
            ...
            paraphrased_attempt._prompt = checkmate.attempt.Message(
...
class Fast(Buff, HFCompatible):
    ...
    DEFAULT_PARAMS = Buff.DEFAULT_PARAMS | {
        "para_model_name": "checkmate-llm/chatgpt_paraphraser_on_T5_base",
