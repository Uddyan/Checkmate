...
"""Pilot-friendly YAML configuration loader for Checkmate.

Provides a simplified configuration system that translates
to the internal checkmate/_config structure.
"""
...
class ProfileConfig(BaseModel):
    ...
    preset: str = Field(..., description="Preset attack pack: smoke-test, chatbot_basic")
    ...
    def validate_preset(cls, v):
        ...
        valid_presets = ['chatbot_basic', 'smoke-test', 'smoke_test']
...
def validate_pilot_config_file(config_path: Path) -> tuple:
