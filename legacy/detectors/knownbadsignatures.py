...
from checkmate.detectors.base import StringDetector
import checkmate.probes.av_spam_scanning
...
class EICAR(StringDetector):
    ...
    def __init__(self, config_root=_config):
        self.substrings = [checkmate.probes.av_spam_scanning.EICAR_SIGNATURE]
...
class GTUBE(StringDetector):
    ...
    def __init__(self, config_root=_config):
        self.substrings = [checkmate.probes.av_spam_scanning.GTUBE_SIGNATURE]
        super().__init__(self.substrings, config_root=config_root)
...
class GTphish(StringDetector):
    ...
    def __init__(self, config_root=_config):
        self.substrings = [checkmate.probes.av_spam_scanning.GTPHISH_SIGNATURE]
        super().__init__(self.substrings, config_root=config_root)
