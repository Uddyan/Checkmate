...
from checkmate.detectors.base import Detector, StringDetector
...
class MarkdownExfilBasic(Detector):
    ...
    def detect(self, attempt: checkmate.attempt.Attempt) -> List[float]:
        results = []
...
class XSS(StringDetector):
    ...
    def _load_substrings(self):
        ...
        for payload in self.payloads:
            substrings += checkmate.payloads.load(payload).payloads
        return substrings
