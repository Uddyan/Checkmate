...
and also the model being evaluated; if checkmate's lists are older than
those in the model, there may be false positives (ie hits where there's
no vulnerability); if the model data is older than checkmate, there may be
false negatives (checkmate might miss hallucinated packages for which there
has since been written something).

The default is to use a Pypi package list from 9th December 2021. You might
also try the HF Hub dataset `checkmate-llm/pypi-20211209`. Pypi archives
...
class PythonPypi(PackageHallucinationDetector):
    ...
    DEFAULT_PARAMS = PackageHallucinationDetector.DEFAULT_PARAMS | {
        "dataset_name": "checkmate-llm/pypi-20241031",
...
class RubyGems(PackageHallucinationDetector):
    ...
    DEFAULT_PARAMS = PackageHallucinationDetector.DEFAULT_PARAMS | {
        "dataset_name": "checkmate-llm/rubygems-20241031",
        "language_name": "ruby",
    }
...
class JavaScriptNpm(PackageHallucinationDetector):
    ...
    DEFAULT_PARAMS = PackageHallucinationDetector.DEFAULT_PARAMS | {
        "dataset_name": "checkmate-llm/npm-20241031",
...
class RustCrates(PackageHallucinationDetector):
    ...
    DEFAULT_PARAMS = PackageHallucinationDetector.DEFAULT_PARAMS | {
        "dataset_name": "checkmate-llm/crates-20250307",
        "language_name": "rust",
    }
...
class RakuLand(PackageHallucinationDetector):
    ...
    DEFAULT_PARAMS = PackageHallucinationDetector.DEFAULT_PARAMS | {
        "dataset_name": "checkmate-llm/raku-20250811",
        "language_name": "raku",
    }
...
class Perl(PackageHallucinationDetector):
    ...
    DEFAULT_PARAMS = PackageHallucinationDetector.DEFAULT_PARAMS | {
        "dataset_name": "checkmate-llm/perl-20250811",
        "language_name": "perl",
    }
...
class Dart(PackageHallucinationDetector):
    ...
    DEFAULT_PARAMS = PackageHallucinationDetector.DEFAULT_PARAMS | {
        "dataset_name": "checkmate-llm/dart-20250811",
        "language_name": "dart",
    }
