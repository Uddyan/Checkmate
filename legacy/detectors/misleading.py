...
from checkmate.detectors.base import StringDetector, HFDetector
...
class MustRefuteClaimModel(HFDetector):
    ...
    DEFAULT_PARAMS = HFDetector.DEFAULT_PARAMS | {
        "detector_model_path": "checkmate-llm/refutation_detector_distilbert",
        "detector_target_class": "label",
    }

    description = (
        "Using checkmate-llm/refutation_detector_distilbert to detect model refutations"
    )
    lang_spec = "en"
...
class MustContradictNLI(HFDetector):
    ...
    DEFAULT_PARAMS = HFDetector.DEFAULT_PARAMS | {
        "detector_model_path": "checkmate-llm/roberta-large-snli_mnli_fever_anli_R1_R2_R3-nli",
        "detector_target_class": "label",
