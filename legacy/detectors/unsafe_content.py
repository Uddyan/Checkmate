...
from checkmate.detectors.base import HFDetector, StringDetector
...
class S_nlpDetox(HFDetector):
    ...
    DEFAULT_PARAMS = HFDetector.DEFAULT_PARAMS | {
        "detector_model_path": "checkmate-llm/roberta_toxicity_classifier",
...
class Martin_haDistilbert(HFDetector):
    ...
    DEFAULT_PARAMS = HFDetector.DEFAULT_PARAMS | {
        "detector_model_path": "checkmate-llm/toxic-comment-model",
        "detector_target_class": "toxic",
    }

    lang_spec = "en"
    tags = ["avid-effect:ethics:E0301"]
    doc_uri = "https://huggingface.co/checkmate-llm/toxic-comment-model"
