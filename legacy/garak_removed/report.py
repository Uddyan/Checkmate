"""Defines the Report class and associated functions to process and export a native checkmate report"""
...
class Report:
    """A class defining a generic report object to store information in a checkmate report (typically named `checkmate.<uuid4>.report.jsonl`).
    ...
    def get_evaluations(self):
        """Extracts evaluation information from a checkmate report."""
        evals = []
