...
def forward(
    ...
    Args:
        generator (checkmate.generators.huggingface.Model): Generator with model for forward pass
...
class AutoDanPrefixManager:
    def __init__(self, *, generator, conv_template, instruction, target, adv_string):
        ...
        Args:
            generator (checkmate.generators.huggingface.Model): Generator to use
