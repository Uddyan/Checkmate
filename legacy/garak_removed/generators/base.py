...
All `checkmate` generators must inherit from this.
"""
...
class Generator(Configurable):
    ...
    def _call_model(
        ...
        here - see checkmate.generators.openai for an example usage.
        ...
        if generations_this_call == 1:
            ...
            if (
                ...
                multi_generator_bar = tqdm.tqdm(
                    ...
                    leave=False,
                    colour=f"#{checkmate.resources.theme.GENERATOR_RGB}",
                )
