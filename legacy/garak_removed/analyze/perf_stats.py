...
def build_score_dict(filenames):
    ...
    distribution_dict["checkmate_calibration_meta"] = {
...
def main(argv=None) -> None:
    ...
    _config.load_config()
    print(
        f"checkmate {checkmate.__description__} v{_config.version} ( https://github.com/NVIDIA/checkmate )"
    )

    parser = argparse.ArgumentParser(
        prog="python -m checkmate.analyze.perf_stats",
        description="Compute performance statistics across one or more checkmate JSONL reports",
    ...
    parser.add_argument(
        ...
        metavar="REPORT",
        nargs="+",
        help="One or more checkmate JSONL report paths",
    )
    parser.add_argument(
        "reports_positional",
        nargs="*",
        help="One or more checkmate JSONL report paths (positional)",
    )
