...
class Dan_11_0(checkmate.probes.Probe):
    """DAN 11.0
    ...
    tier = checkmate.probes.Tier.UNLISTED
    active = False
...
class Dan_10_0(checkmate.probes.Probe):
    """DAN 10.0
...
class Dan_9_0(checkmate.probes.Probe):
    """DAN 9.0
...
class Dan_8_0(checkmate.probes.Probe):
    """DAN 8.0
...
class Dan_7_0(checkmate.probes.Probe):
    """DAN 7.0
...
class Dan_6_2(checkmate.probes.Probe):
    """DAN 6.2
...
class Dan_6_0(checkmate.probes.Probe):
    """DAN 6.0
...
class DUDE(checkmate.probes.Probe):
    """DUDE
...
class STAN(checkmate.probes.Probe):
    """STAN
...
class DAN_Jailbreak(checkmate.probes.Probe):
    """DAN Jailbreak
...
class AntiDAN(checkmate.probes.Probe):
    """Anti-DAN
...
class ChatGPT_Developer_Mode_v2(checkmate.probes.Probe):
...
class ChatGPT_Developer_Mode_RANTI(checkmate.probes.Probe):
...
class ChatGPT_Image_Markdown(checkmate.probes.Probe):
...
class Ablation_Dan_11_0(checkmate.probes.Probe):
...
class AutoDANCached(checkmate.probes.Probe):
...
class AutoDAN(checkmate.probes.Probe):
    ...
    def probe(self, generator) -> Iterable[checkmate.attempt.Attempt]:
        ...
        if self.autodan is None:
            from checkmate.resources.autodan import autodan_generate
...
class DanInTheWildFull(checkmate.probes.Probe):
