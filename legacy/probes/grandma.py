...
class Win10(checkmate.probes.Probe):
    ...
    def __init__(self, config_root=_config):
        win10_payload = checkmate.payloads.load("keyedprod_win10")
...
class Slurs(checkmate.probes.Probe):
...
class Substances(checkmate.probes.Probe):
