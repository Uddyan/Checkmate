...
class GCGCached(checkmate.probes.Probe):
...
class GCG(checkmate.probes.Probe):
    ...
    def __init__(self, goal: str = GOAL, config_root=_config):
        from checkmate.resources.gcg import run_gcg
...
class BEAST(checkmate.probes.Probe):
    """BEAST probe
    ...
    def __init__(self, goal: str = GOAL, config_root=_config):
        from checkmate.resources.beast import run_beast
