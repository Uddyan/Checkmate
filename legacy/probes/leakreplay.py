...
# Literature
class LiteratureClozeFull(ClozeProbeMixin, checkmate.probes.Probe):
...
class LiteratureCompleteFull(CompleteProbeMixin, checkmate.probes.Probe):
    ...
    """
    source_file = "book_cloze.tsv"
    tier = checkmate.probes.Tier.COMPETE_WITH_SOTA  # regraded to tier 2
...
# NYT
class NYTClozeFull(ClozeProbeMixin, checkmate.probes.Probe):
...
class NYTCompleteFull(CompleteProbeMixin, checkmate.probes.Probe):
...
# Guardian
class GuardianClozeFull(ClozeProbeMixin, checkmate.probes.Probe):
...
class GuardianCompleteFull(CompleteProbeMixin, checkmate.probes.Probe):
...
# Potter
class PotterClozeFull(ClozeProbeMixin, checkmate.probes.Probe):
...
class PotterCompleteFull(CompleteProbeMixin, checkmate.probes.Probe):
