...
from checkmate.exception import ConfigFailure, GarakException
...
class TAPCached(checkmate.probes.Probe):
...
class TAP(checkmate.probes.Probe):
    ...
    def probe(self, generator) -> List[checkmate.attempt.Attempt]:
        ...
        if self.run_tap is None:
            from checkmate.resources.tap import run_tap
...
class PAIR(checkmate.probes.Probe):
