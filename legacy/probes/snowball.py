...
class GraphConnectivityFull(checkmate.probes.Probe):
...
class GraphConnectivity(GraphConnectivityFull, checkmate.probes.Probe):
...
class PrimesFull(checkmate.probes.Probe):
...
class Primes(PrimesFull, checkmate.probes.Probe):
...
class SenatorsFull(checkmate.probes.Probe):
...
class Senators(SenatorsFull, checkmate.probes.Probe):
