...
from checkmate.resources.api import nltk
...
class MLM(checkmate.probes.Probe):
    ...
    def __init__(self, config_root=_config):
        ...
        for payload_class in self.payload_name:
            self.payloads += checkmate.payloads.load(payload_class).payloads
