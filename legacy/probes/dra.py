...
class DRA(checkmate.probes.Probe):
    """DRA (Disguise and Reconstruction Attack)

    This probe is designed to test models using disguised and reconstructed harmful behaviors.
    Behaviors are defined in ``checkmate/data/payloads/harmful_behaviors.json``.
    ...
    def __init__(self, config_root=_config):
        ...
        self.all_behaviors = checkmate.payloads.load(self.payload_name).payloads
